$.get('https://ipapi.co/country/',function(data){let redir=decodeURIComponent(document.cookie);console.log("redir = '"+redir+"'");console.log("data = '"+data+"'");console.log("pathname = '"+window.location.pathname+"'");if(data=='GR'&&window.location.pathname!="/el/"&&redir==''){location.replace("el/");document.cookie="redir=already_redirected_once;";console.log(document.cookie);}})
