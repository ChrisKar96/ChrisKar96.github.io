$.get('https://ipapi.co/country/',function(data){let redir=decodeURIComponent(document.cookie);if(data=='GR'&&window.location.pathname!="/el/"&&redir==''){location.replace("el/");document.cookie="already redirected once;";}})
